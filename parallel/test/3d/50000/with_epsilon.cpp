...
bool run_kmeans() {
    ...
    const std::string data_path = "../../../../datasets/3d/50000_samples_3_centers/data.csv";
    const std::string centroids_path = "../../../../datasets/3d/50000_samples_3_centers/centroids.csv";
